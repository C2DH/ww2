...
export default function Source({ src, handleSourcePopup }) {
    ...
    return (
            <div style={{ backgroundImage: `url(${patternBG})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}} className='w-full h-screen lg:relative lg:top-0 absolute -top-[120px]'>
                ...
                <div className='lg:hidden pt-[80px] pb-[20px] flex justify-center border-b border-white'>
                    <span className='text-white uppercase text-[24px]' onClick={ handleSourcePopup }>FERMER</span>
                </div>

                <div className="container mx-auto relative flex h-[calc(100vh-140px)] px-[20px] overflow-scroll">
