    ...
    >
      ...
      <div
        className={classNames(
          'hidden lg:block absolute top-[40px] left-[40px] text-[30px] text-white z-[100]',
          {
      ...
      <div
        className={classNames('container mx-auto relative px-[20px]', {
          ...
          <div className='col-span-12 lg:col-span-3 lg:col-start-10 lg:border-l text-white overflow-scroll lg:pr-[30px]'>
            {data.covers?.map((item) => {
              if (item.type === 'glossary') {
                return (
                  <div key={item.id}>
                    <h1 className='lg:pl-[25px] text-[30px] font-semibold pt-[30px] pb-[30px]'>
                      {item.data.title[language]}
                    </h1>
                    <hr className='w-1/2' />
                    <p className='lg:pl-[25px] text-[30px] font-semibold pt-[30px] pb-[30px]'>
            ...
            {(data.type === 'book' ||
              ...
              <>
                ...
                <hr className='w-1/2' />
                <span className='block lg:pl-[25px] text-[30px] font-semibold pt-[30px] pb-[30px]'>
                  Publisher :{' '}
                ...
                <Link
                  ...
                  target='_blank'
                  className='block lg:pl-[25px] text-[30px] font-semibold pt-[30px] pb-[30px]'
                >
                  Lien :{' '}
        ...
        <>
          <TransformComponent>
            <img
              src={image}
              alt={alt}
              className='w-full max-h-[400px] 2xl:max-h-[750px] object-cover'
            />
          </TransformComponent>
