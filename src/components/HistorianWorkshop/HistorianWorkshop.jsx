                            ...
                            <div className='absolute inset-0'>
                                <svg viewBox="0 0 1432 946" fill="none" xmlns="http://www.w3.org/2000/svg" className='relative w-full h-[70vh]'>
                                    ...
                                    <Link to={"/historical-index"} className='block group transition-all duration-[750ms]'>
                                        ...
                                        <text x="580" y="268" r="11" fill="transparent" className='transition-all duration-[750ms] text-[36px] group-hover:opacity-1 group-hover:fill-[#6EDFFB] uppercase'>Index historique</text> 
                                    </Link>
                                    ...
                                    <Link to={"/sources"} className='block group transition-all duration-[750ms]'>
                                        ...
                                        <text x="300" y="692" r="11" fill="transparent" className='transition-all duration-[750ms] text-[36px] group-hover:opacity-1 group-hover:fill-[#6EDFFB] uppercase'>Sources</text> 
                                    </Link>
                                    ...
                                    <Link to={"/research-institutions"} className='block group transition-all duration-[750ms]'>
                                        ...
                                        <text x="800" y="294" r="11" fill="transparent" className='transition-all duration-[750ms] text-[36px] group-hover:opacity-1 group-hover:fill-[#6EDFFB] uppercase'>Institutions de recherche</text> 
                                    </Link>
