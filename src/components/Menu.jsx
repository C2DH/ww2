...
export default function Menu() {
    ...
    return (
        <header className='h-[100vh] relative' style={{ background: `url(${bg}) lightgray 50% / cover no-repeat`, backgroundBlendMode: ''}}>
            <div className="flex justify-between px-[90px] pt-[20px]">
                <div>
                    <span className="text-[20px]">SOUND ON</span>
                    <FontAwesomeIcon icon={ faVolume } style={{ fontSize: '26px', marginLeft: '10px' }}/>
                </div>

                <div>   
                    <span className='text-[20px]'>EN DE FR</span>
                </div>
            </div>
            ...
            <div className='absolute top-[3px] left-[50%] -translate-x-[50%]'>
                <Link to="/">
                    ...
                    <img src={ logoMenu } alt="Logo Menu" className='w-[300px]'/>
                </Link>
            </div>
