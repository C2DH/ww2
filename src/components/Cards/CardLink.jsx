...
export default function CardLink() {
    return (
        <div className="col-span-12 md:col-span-6 border border-black rounded-[5px] p-[10px] h-[240px] lg:h-[140px] hover:bg-[#0e4b5a]/[0.15] transition-all duration-[750ms]">
            <div className="grid grid-cols-6 gap-x-[20px]">
                <div className="col-span-6 lg:col-span-2">
                    <img src="https://source.unsplash.com/random" alt="" className='rounded-[2px] object-cover h-[120px] w-full' />
                </div>
