        ...
        <>
            <div className="hidden lg:grid grid-cols-12 lg:pt-[20px] 2xl:pt-[50px]">
                <div className="col-span-12 lg:col-span-7 2xl:col-span-9">
                    <h1 className='text-[50px] 2xl:text-[70px] font-abril leading-none pb-[20px] xl:pb-[50px]'>L'atelier de l'historien</h1>
                </div>
            ...
            <nav className='hidden lg:block'>
                <ul className='text-[28px] 2xl:text-[38px] font-semibold uppercase flex gap-[20px]'>
